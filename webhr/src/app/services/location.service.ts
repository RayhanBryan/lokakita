...
export class LocationService {
  ...
  searchLocation(keyword: string): Observable<any> {
    return this.http.get<any>(
      this.locationUrl + `getByStreetAddress?streetAddress=${keyword}`,
      httpOptions
    );
  }
  ...
  getLocationById(locationId: number): Observable<any> {
    return this.http.get<any>(
      this.locationUrl + `getById?id=${locationId}`,
      httpOptions
    );
  }
  ...
  searchLocationByCity(keyword: string) {
    return this.http.get<any>(
      this.locationUrl + `getByCity?city=${keyword}`,
      httpOptions
    );
  }
  ...
  searchLocationByCountryName(keyword: string) {
    return this.http.get<any>(
      this.locationUrl + `getByCountryName?countryName=${keyword}`,
      httpOptions
    );
  }
  ...
  searchLocationByStateProvince(keyword: string) {
    return this.http.get<any>(
      this.locationUrl + `getByStateProvince?stateProvince=${keyword}`,
      httpOptions
    );
  }
  ...
  getStateProvince(countryId: string) {
    return this.http.get<any>(
      this.locationUrl + `getStateProvinceByCountryId?countryId=${countryId}`,
      httpOptions
    );
  }
}
